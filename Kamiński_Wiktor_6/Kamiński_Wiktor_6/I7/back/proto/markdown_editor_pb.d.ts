...
export class FileNameRequest extends jspb.Message { 
    getFilename(): string;
    setFilename(value: string): FileNameRequest;
...
export class FilesList extends jspb.Message { 
    ...
    setNameList(value: Array<string>): FilesList;
...
export class FileContent extends jspb.Message { 
    getContent(): string;
    setContent(value: string): FileContent;
...
export class OperationResult extends jspb.Message { 
    ...
    setSuccessful(value: boolean): OperationResult;

    getErrormsg(): string;
    setErrormsg(value: string): OperationResult;
...
export class SaveFileRequest extends jspb.Message { 
    ...
    setContent(value?: FileContent): SaveFileRequest;
